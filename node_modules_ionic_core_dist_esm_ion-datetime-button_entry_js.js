...
/* harmony import */ var _parse_d395420d_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./parse-d395420d.js */ 1210);
...
Please upvote https://github.com/ionic-team/ionic-framework/issues/25668 if you are interested in seeing this functionality added.
      ...
      const parsedDatetime = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_6__.p)(value || (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_6__.e)());
      const use24Hour = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_6__.D)(locale, hourCycle); // TODO(FW-1865) - Remove once FW-1831 is fixed.
      ...
      switch (datetimePresentation) {
        case 'date-time':
        case 'time-date':
          const dateText = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_6__.N)(locale, parsedDatetime);
          const timeText = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_6__.E)(locale, parsedDatetime, use24Hour);
        ...
        case 'date':
          this.dateText = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_6__.N)(locale, parsedDatetime);
          break;

        case 'time':
          this.timeText = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_6__.E)(locale, parsedDatetime, use24Hour);
          break;

        case 'month-year':
          this.dateText = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_6__.A)(locale, parsedDatetime);
          break;

        case 'month':
          this.dateText = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_6__.M)(locale, parsedDatetime, {
            month: 'long'
          });
          break;
    ...
    this.waitForDatetimeChanges = /*#__PURE__*/(0,C_Users_Jeremy_SideProjects_campaign_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
    ...
    this.handleDateClick = /*#__PURE__*/function () {
      var _ref2 = (0,C_Users_Jeremy_SideProjects_campaign_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
        const {
          datetimeEl,
          datetimePresentation
        } = _this;
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,C_Users_Jeremy_SideProjects_campaign_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
